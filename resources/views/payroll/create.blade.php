                              ...
                              <td style="vertical-align: top" width="50%">
                                 <table width="100%" id="pay_period_and_salary">
                                    <tbody>
                                       ...
                                       <tr>
                                          <td width="50%" class="cell_format">{{trans_choice('general.cogregation',1)}} {{trans_choice('general.name',1)}}</td>
                                          <td width="50%" class="cell_format">
                                             <div class="margin text-bold">
												 ...
												 <select class="form-control pension_fund" name="pension_fund" onchange="refresh_totals()">
													 ...
													 @if(!empty($pension_fund))
													 	@foreach($pension_fund as $fund)
													 		<option value="{{$fund->id}}" data-employer_contribution="{{$fund->amount}}" data-type="{{$fund->type}}">{{$fund->name}}</option>
													 	@endforeach
													 @endif
												 </select>
                                             </div>
