...
@section('content')
    <div class="box box-primary">
        ...
        <div class="box-body">
            <div class="col-md-12">
                ...
                <div class="form-group ">
                    ...
                    {!! Form::email('email','',array('class'=>'email form-control','required'=>'required')) !!}
                </div>
                <div class="form-group">
				...
				<div class="form-group state_province_append"></div>
				<div class="form-group branches_append"></div>
				<div class="form-group">
        ...
        <div class="box-footer">
            <button type="button" class="btn btn-primary pull-right save">{{trans_choice('general.save',1)}}</button>
        </div>
        {!! Form::close() !!}
    </div>
@endsection
@section('footer-scripts')
	...
	<script>
		...
		$(document).on('click','.save',function(){
			...
			if((successFlag == true) && (emailValidate == true))
			{
				$('form').submit();
			}
		});
