...
<h3 class="text-center"><b>{{$payslip_heading->dioces->name}}</b></h3>
<h3 class="text-center"><b>{{$payslip_heading->state->name}}</b></h3>
<h3 class="text-center"><b>{{$payslip_heading->name}}</b></h3>
                ...
                <tr>
                        ...
                        <table width="100%" id="payslip_employee_header">
                            ...
                            @foreach($top_left as $key)
                                <tr>
                                    <td width="50%" class="cell_format">
                                        <div class="margin">
                                            @if(!empty($key->pension_template_meta))
                                                {{$key->pension_template_meta->name}}
                                            @endif
                                        </div>
                                    </td>
                                    <td width="50%" class="cell_format">
                    ...
                    <td style="vertical-align: top" width="50%">
                        ...
                        <table width="100%" id="pay_period_and_salary">
                            ...
                            <tr>
                                <td width="50%" class="cell_format">
                                    <div class="margin"><b>{{trans_choice('general.pension',1)}} {{trans_choice('general.date',1)}}</b></div>
                                </td>
                                <td width="50%" class="cell_format">
                                    <div class="margin text-bold">
                                        {!! $pension->date !!}
                    ...
                    <td width="50%" class="bg-gray">
                        <table width="100%" id="gross_pay">
                            ...
                            <tr>
                                ...
                                <td width="50%" class="cell_format">
                                    <div class="margin text-bold">
                                        {!! \App\Helpers\GeneralHelper::single_pension_total_pay($pension->id) !!}
                                    </div>
                                </td>
                            </tr>
                            </tbody>
                    ...
                    <td width="50%" class="bg-gray">
                        ...
                        <table width="100%" id="gross_pay">
                            ...
                            <tr>
                                ...
                                <td width="50%" class="cell_format">
                                    <div class="margin text-bold">
                                        {!! \App\Helpers\GeneralHelper::single_pension_total_deductions($pension->id) !!}
                                    </div>
                                </td>
                            </tr>
                            </tbody>
                    ...
                    <td width="50%" class="bg-gray">
                        <table width="100%" id="gross_pay">
                            ...
                            <tr>
                                ...
                                <td width="50%" class="cell_format">
                                    <div class="margin text-bold">
                                        {!! \App\Helpers\GeneralHelper::single_pension_total_pay($pension->id)-\App\Helpers\GeneralHelper::single_pension_total_deductions($pension->id) !!}
                                    </div>
                                </td>
                            </tr>
                            </tbody>
