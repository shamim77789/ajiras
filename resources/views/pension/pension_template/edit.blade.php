...
@section('title'){{trans_choice('general.edit',1)}} {{trans_choice('general.pension',1)}} {{trans_choice('general.template',1)}}
@endsection
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">{{trans_choice('general.edit',1)}} {{trans_choice('general.pension',1)}} {{trans_choice('general.template',1)}}</h3>

            <div class="box-tools pull-right">

            </div>
        </div>
        {!! Form::open(array('url' => url('pension/template/'.$id.'/update'), 'method' => 'post', 'class' => 'form-horizontal')) !!}
        <div class="box-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    @foreach($top_left as $key)
                        <div class="form-group" id="{{$key->id}}">
                            ...
                            <div class="col-sm-2">
                                @if($key->is_default==0)
                                    <a href="{{url('pension/template/'.$id.'/delete_meta?action=delete_meta&meta_id='.$key->id)}}"
                ...
                <div class="col-md-6">
                    <div class="form-group" id="">
                        <div class="col-sm-10">
                            <label>{{trans_choice('general.pension',1)}} {{trans_choice('general.date',1)}}</label>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="addRow">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                {!! Form::open(array('url' => url('pension/template/'.$id.'/add_row'),'class'=>'','id'=>'paypalForm')) !!}
