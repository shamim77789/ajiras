...
@section('title')
    {{trans_choice('general.propotional_contribution',1)}}
@endsection
@section('content')
            ...
            <div class="col-sm-6">
                <table class="table table-bordered table-condensed table-hover">
                    ...
                    <tr style="background-color: #F2F8FF">
                        ...
                        <td style="text-align:center"><b>{{trans_choice('general.campaign_name',1)}} </b></td>
                        <td style="text-align:center"><b>{{trans_choice('general.ratio',1)}} </b></td>
