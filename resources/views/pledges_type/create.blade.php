...
@section('title')
    {{trans_choice('general.add',1)}} {{trans_choice('general.campaign',1)}} {{trans_choice('general.type',1)}}
@endsection
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">{{trans_choice('general.add',1)}} {{trans_choice('general.campaign',1)}} {{trans_choice('general.type',1)}}</h3>

            <div class="box-tools pull-right">

            </div>
        </div>
        {!! Form::open(array('url' => url('pledge/campaign_type/store'), 'method' => 'post', 'class' => 'form-horizontal')) !!}
